...
import { FETCH_CAMPER_TRAVEL_EXTENTION } from 'state/concepts/camper/types';
import { fetchCamperTravelExtentionEndpoint } from 'state/concepts/camper/endpoints';

const fetchCamperTravelExtention = createLogic({
...
export default fetchCamperTravelExtention;
