      ...
      <Row gutter={24}>
        ...
        <Col span={24}>
          ...
          >
            ...
            <Col md={11} xl={14}>
              <p className="mb-16 mb-md-0">
                It is the responsibility of the renter to return the fuel tanks with the same level
                of
            ...
            <Col md={11} xl={14}>
              <p className="mb-16 mb-md-0">
                If the late return interferes with another booking, the late fee is the full nightly
