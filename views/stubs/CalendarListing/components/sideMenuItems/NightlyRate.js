      ...
      >
        <Form layout="vertical">
          <div className="calendar-listing__side-slideout__main">
            ...
            <h3 className="text-subheader mb-16">Nightly rate</h3>
            {range ? (
              <>
                <Form.Item
                  className="mb-24"
                  label={
                    <span className="main-input__label">Cost per night</span>
                  }
                >
                  <Input
                    defaultValue="$160"
                ...
                {customize && (
                  <>
                    ...
                    <Form.Item
                      label={
                        <span className="main-input__label">Wednesday</span>
                      }
                    >
                      <Input defaultValue="$350" className="pr-80" />
                      <span className="main-input__add-txt">per night</span>
                    ...
                    <Form.Item
                      label={
                        <span className="main-input__label">Thursday</span>
                      }
                    >
                      <Input defaultValue="$350" className="pr-80" />
                      <span className="main-input__add-txt">per night</span>
                    ...
                    <Form.Item
                      label={
                        <span className="main-input__label">Saturday</span>
                      }
                    >
                      <Input defaultValue="$350" className="pr-80" />
                      <span className="main-input__add-txt">per night</span>
