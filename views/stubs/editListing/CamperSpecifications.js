          ...
          <Col lg={16}>
            <Row gutter={24}>
              <Col span={24}>
                ...
                <p className="mb-16 text-color-gray">
            ...
            <Row>
              <Col span={24}>
                ...
                <Row gutter={24}>
                  <Col md={12}>
                    <Form.Item
                      label={<span className="main-input__label">Fresh water</span>}
                    >
                      <Input />
                    </Form.Item>
                  </Col>
                  <Col md={12}>
                    <div className="d-flex align-items-center relative">
                      <Form.Item
                        ...
                        label={<span className="main-input__label">Gray water</span>}
                      >
                        <Input />
                      </Form.Item>
                      <TooltipIcon
...
export default CamperSpecifications;
