...
import PreparationTime, { PreparationTimeContainer } from '../container';
...
describe('PreparationTime container tests', () => {
  ...
  beforeEach(() => {
    wrapper = shallow(<PreparationTime {...props} />);
    container = diveTo(wrapper, PreparationTimeContainer);
