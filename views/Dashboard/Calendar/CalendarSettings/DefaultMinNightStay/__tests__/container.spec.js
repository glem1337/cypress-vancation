...
import DefaultMinNightStay, { DefaultMinNightStayContainer } from '../container';
...
describe('DefaultMinNightStay container tests', () => {
  ...
  beforeEach(() => {
    wrapper = shallow(<DefaultMinNightStay {...props} />);
    container = diveTo(wrapper, DefaultMinNightStayContainer);
