...
import {
  CALENDAR_PICKUP_TIME_OPTIONS,
  CALENDAR_DROP_OFF_OPTIONS,
...
const PickUpTimeComponent = (props) => {
  const {
    toggleOpenedState,
    isOpened,
  ...
  return (
    <div className="calendar-listing__side-main-item">
      <Button className="ant-btn-slideout" onClick={toggleOpenedState}>
        ...
        <span>
          <FormattedMessage id="shared.pickupDropOffTime" />
        </span>
      ...
      >
        <Form layout="vertical">
          <div className="calendar-listing__side-slideout__main">
            ...
            <p className="mb-16">
              <FormattedMessage id="calendar.pickupDropOffTimeDescription" />
            </p>
            <Field
              name="pickupTime"
              ...
              label={{ id: 'shared.pickupTime' }}
              placeholder={{ id: 'shared.select' }}
              items={CALENDAR_PICKUP_TIME_OPTIONS}
            />
            <Field
              name="dropOffTime"
              className="main-input__field"
              optionLabelProp="label"
              component={SelectField}
              label={{ id: 'shared.dropOffTime' }}
              placeholder={{ id: 'shared.select' }}
              items={CALENDAR_DROP_OFF_OPTIONS}
...
export default PickUpTimeComponent;
